...
public class pcinfo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(PCN == 1){
            setContentView(R.layout.pcinfo1);
        }
        else if(PCN == 2){
            setContentView(R.layout.pcinfo2);
        }
        else if(PCN == 3){
            setContentView(R.layout.pcinfo3);
        }
        else if(PCN == 4){
            setContentView(R.layout.pcinfo4);
        }
        else if(PCN == 5){
            setContentView(R.layout.pcinfo5);
        }
        else if(PCN == 6){
            setContentView(R.layout.pcinfo6);
        }
    }
}
